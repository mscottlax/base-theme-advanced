...
class MCE_Table_Buttons {
    ...
    public static function the_editor( $editor ) {
        ...
        if ( version_compare( $tinymce_version, '400', '<' ) ) {
            ...
            wp_register_style( 'mce-table-buttons', get_template_directory_uri() . '/vendor/php/tinymce-tables/tinymce3-assets/mce-table-buttons.css' );
    ...
    public static function mce_external_plugins_3_8( $plugin_array ) {
        $plugin_dir_url = get_template_directory_uri() . '/vendor/php/tinymce-tables/';
    ...
    public static function mce_external_plugins_3_9( $plugin_array ) {
        ...
        $plugin_array['table'] = get_template_directory_uri() . '/vendor/php/tinymce-tables/tinymce4-table/plugin.js';
        return $plugin_array;
    }
