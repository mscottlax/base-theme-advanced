...
//include LIB_DIR . "/php/tinymce-tables/mce_table_buttons.php";

/**
 * Include the TGM_Plugin_Activation class.
 */
require_once LIB_DIR . '/php/class-tgm-plugin-activation.php';
...
function my_theme_register_js_composer_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'source'            => LIB_DIR . '/plugins/gravityforms_1.8.18.zip', // The plugin source
        ...
        array(
            ...
            'source'            => LIB_DIR . '/plugins/js_composer.zip', // The plugin source
            'required'          => true, // If false, the plugin is only 'recommended' instead of required
        ...
        array(
            ...
            'source'            => LIB_DIR . '/plugins/advanced-custom-fields-pro.zip', // The plugin source
            'required'          => true, // If false, the plugin is only 'recommended' instead of required
